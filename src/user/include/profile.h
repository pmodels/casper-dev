...
#define CSP_FUNC_PROFILE_TIMING_START(func) CSP_time_t _profile_##func##_time_start = CSP_time();
#define CSP_FUNC_PROFILE_TIMING_END(func) {   \
    ...
    if (PROF_##func >= 0 && PROF_##func < PROF_MAX_NUM_PROFILE_FUNC) \
        CSP_time_acc(_profile_##func##_time_start, CSP_time(), &CSP_prof_timings[PROF_##func]);   \
}
